...
const Testimonials = () => {
  ...
  return (
    <section className="relative py-24 z-2 md:py-28 lg:py_40">
          ...
          <div className="testimonials_group-after flex-50 ">
            {testimonials.slice(0, halfLength).map((testimonial) => (
              <TestimonialItem
                ...
                classContainer="last:after:hidden last:after:max-md:block"
              />
            ))}
          </div>
          <div className="flex-50">
            {testimonials.slice(halfLength).map((testimonial) => (
              <TestimonialItem
                key={testimonial.id}
                testimonial={testimonial}
                classContainer="last:after:hidden after:right-auto after:left-0 after:max-md:-left-4 md:px-12"
              />
            ))}
          </div>
        </div>
